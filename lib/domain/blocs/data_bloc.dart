...
class TaskListSwitchCompleted extends TaskListEvent {}
...
class DataBloc extends Bloc<TaskListEvent, TaskListState> {
  final _client = ApiClient();
  final DatabaseHelper _databaseHelper = DatabaseHelper.instance;

  DataBloc(TaskListState initialState) : super(initialState) {
    on<TaskListEvent>((event, emit) async {
      if (event is TaskListUpdate) {
        ...
        _onTaskListChangeTaskState(event, emit);
      } else if (event is TaskListSwitchCompleted) {}
